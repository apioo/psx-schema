...
class CommonProperties implements \JsonSerializable
{
    ...
    {
        return array_filter(array('title' => $this->title, 'description' => $this->description, 'type' => $this->type, 'nullable' => $this->nullable, 'deprecated' => $this->deprecated, 'readonly' => $this->readonly), static function ($value) : bool {
            return $value !== null;
        });
    }
}
class ScalarProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('format' => $this->format, 'enum' => $this->enum, 'default' => $this->default), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class ContainerProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('type' => $this->type), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class StructProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('properties' => $this->properties, 'required' => $this->required), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class MapProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('additionalProperties' => $this->additionalProperties, 'maxProperties' => $this->maxProperties, 'minProperties' => $this->minProperties), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class ArrayProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('type' => $this->type, 'items' => $this->items, 'maxItems' => $this->maxItems, 'minItems' => $this->minItems, 'uniqueItems' => $this->uniqueItems), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class NumberProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('type' => $this->type, 'multipleOf' => $this->multipleOf, 'maximum' => $this->maximum, 'exclusiveMaximum' => $this->exclusiveMaximum, 'minimum' => $this->minimum, 'exclusiveMinimum' => $this->exclusiveMinimum), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class StringProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('type' => $this->type, 'maxLength' => $this->maxLength, 'minLength' => $this->minLength, 'pattern' => $this->pattern), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class Discriminator implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('propertyName' => $this->propertyName, 'mapping' => $this->mapping), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class AllOfProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('description' => $this->description, 'allOf' => $this->allOf), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class OneOfProperties implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('description' => $this->description, 'discriminator' => $this->discriminator, 'oneOf' => $this->oneOf), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class ReferenceType implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('$ref' => $this->ref, '$template' => $this->template), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class GenericType implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('$generic' => $this->generic), static function ($value) : bool {
            return $value !== null;
        });
    }
}
...
class TypeSchema implements \JsonSerializable
{
    ...
    public function jsonSerialize()
    {
        return array_filter(array('$import' => $this->import, 'title' => $this->title, 'description' => $this->description, 'type' => $this->type, 'definitions' => $this->definitions, 'properties' => $this->properties, 'required' => $this->required), static function ($value) : bool {
            return $value !== null;
        });
    }
}